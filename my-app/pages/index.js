...
export default function Home() {
  ...
  const getNumberOfWhitelisted = async () => {
    try {
      ...
      setNumberOfWhitelisted(parseInt(_numberOfWhitelisted));
    } catch (err) {
      console.error("Error getting number of whitelisted addresses:", err);
    }
  };
  ...
  const checkIfAddressInWhitelist = async () => {
    try {
      ...
      console.error("Error checking if address is in whitelist:", err);
    }
  };
